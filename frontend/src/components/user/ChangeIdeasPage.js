...
export default function ChangeIdeasPage() {
...
export function ChangeIdeasPageComponent({
    handleBackButton,
    }) {
    return (
        <>
            <div className=''>
                ...
                <Card body bg='light' className='border-0'>
                    <div className='d-flex'>
                        ...
                        {/* This is the title */}
                        <div className='h1 fw-bold d-inline-block mb-auto mt-auto'>Change Ideas</div>
                        {/* Settings */}
                        <Hover 
