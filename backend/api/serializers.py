...
class TeamMembershipSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'user', 'team_pk', 'team_name', 'team_get_members', 'is_admin', 'joined_date']
...
class UserTeamSerializer(serializers.ModelSerializer):
    ...
    team_get_members = serializers.ReadOnlyField(source='get_members') # Get the read only value from the function to see whose on the team
